...
VALUES
  ...
  (gen_random_uuid(), 'Masteri Grand View', 'Masterise Homes', 'The Global City, An Phú, TP. Thủ Đức', 'Thủ Đức', 'Hồ Chí Minh', 'Masteri Grand View là phân khu căn hộ đầu tiên của The Global City với 27 tòa tháp nằm dọc theo kênh đào, mang đến tầm view đẳng cấp.', 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=800', 140000000, '8 - 30 tỷ', 9.0, 'Đang mở bán', 3000, 500, 45, '2024-12-01', '2028-06-01', ARRAY['Canal View', 'Infinity Pool', 'Sky Garden', 'Premium Gym', 'Co-living Space'], ARRAY['1PN', '2PN', '3PN', 'Duplex']),
  ...
  (gen_random_uuid(), 'Masteri Thao Dien', 'Masterise Homes', 'Xa lộ Hà Nội, Phường Thảo Điền, TP. Thủ Đức', 'Thủ Đức', 'Hồ Chí Minh', 'Masteri Thảo Điền là dự án căn hộ cao cấp đầu tiên của Masterise Homes, nằm ngay trung tâm khu Thảo Điền sầm uất.', 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800', 75000000, '3.5 - 15 tỷ', 9.0, 'Đã bàn giao', 1500, 1500, 45, '2015-03-01', '2017-12-01', ARRAY['Hồ bơi', 'Gym', 'Sky Garden', 'BBQ Area', 'Kids Club'], ARRAY['1PN', '2PN', '3PN', 'Penthouse']),
