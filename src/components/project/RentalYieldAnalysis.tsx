    ...
    <Card className="hover-lift bg-card border-border shadow-sm">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-primary/10 border-primary/20 border">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs text-muted-foreground mb-1 font-medium">Rental Yield</div>
          ...
          <Card className="bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800 border">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs text-muted-foreground mb-1 font-medium">Giá thuê TB</div>
          ...
          <Card className="bg-purple-50 dark:bg-purple-950/30 border-purple-200 dark:border-purple-800 border">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs text-muted-foreground mb-1 font-medium">Công suất</div>
        ...
        {latestData.rental_price_min && latestData.rental_price_max && (
          <div className="space-y-2">
            <div className="text-sm font-medium text-foreground">Khoảng giá cho thuê</div>
        ...
        <div className="space-y-3">
          <div className="text-sm font-medium text-foreground">Chi tiết theo loại căn</div>
          {rentalData.slice(0, 5).map((data, index) => (
            ...
            >
              <div>
                <div className="font-medium text-sm text-foreground">{data.unit_type}</div>
        ...
        {latestData.average_lease_term_months && (
          <div className="flex items-center gap-2 p-3 bg-muted/30 rounded-lg border border-border/50">
            ...
            <div className="text-sm">
              ...
              <span className="font-medium text-foreground">{latestData.average_lease_term_months} tháng</span>
            </div>
          </div>
        )}
        ...
        {purchasePrice > 0 && latestData.rental_price_avg && (
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/20 border-blue-100 dark:border-blue-900/50">
            <CardContent className="p-4">
              <div className="text-sm font-semibold text-blue-900 dark:text-blue-300 mb-3">Dự tính lợi nhuận cho thuê</div>
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-semibold text-foreground">{formatCurrency(purchasePrice)}</div>
                </div>
                <div>
