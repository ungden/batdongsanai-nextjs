      ...
      <DesktopLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 text-center animate-fade-in">
          ...
          <div className="flex gap-4">
            <Button onClick={() => navigate.push('/auth')} size="lg" className="px-8">
              Đăng nhập ngay
            </Button>
            <Button variant="outline" onClick={() => navigate.push('/market-overview')} size="lg">
              Khám phá thị trường
            </Button>
          </div>
        </div>
  ...
  const content = (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate.push('/market-overview')}>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          action={{
            ...
            onClick: () => navigate.push('/market-overview')
          }}
        />
      ) : (
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 space-y-1">
                          <h3
                            ...
                            onClick={() => navigate.push(`/projects/${item.project_id}`)}
                          >
                            {item.project_name}
                          </h3>
      ...
      <div className="min-h-screen bg-background pb-20">
        ...
        <div className="bg-background sticky top-0 z-10 border-b border-border/50 px-4 py-3 flex items-center justify-between">
          <h1 className="text-xl font-bold">Danh mục</h1>
           <Button size="sm" variant="ghost" onClick={() => navigate.push('/market-overview')}>
